package com.instagram.common.utill;
...
public class JwtUtil {
    @Value("${jwt.secreat}")
    private String secretKeyString; // 인터넷 상 날인, 위조를 방지하기 위한 회사만의 비밀 도장 낙인

    // 토큰 유효 시간 24시간 = 24 * 60 * 60 * 1000
    @Value("${jwt.expiration}")
    private long expirationTime; // 절대 못 바꾸게 final 처리를 안해줘도 못 바꿈, 24시간의 유효기간을 줌
    ...
    /**
     * JWT 토큰 생성
     * 토큰의 형태는 msfmklsfmlrewm34mlsdffsdlfmslf 이 와 같은 형식으로 생성
     */
